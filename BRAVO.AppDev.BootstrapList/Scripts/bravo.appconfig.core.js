...
BRAVO.AppConfig.push(function () {
    ...
    _customActionInfo[BRAVO.App.WebTypes.Site] = [
        { IsScript: true, UseScriptBlock: false, Name: _appTitle, Title: _appTitle, FileUrl: "~sitecollection/Style Library/BRAVO/js/bravo.min.js", Description: _appDescription, Sequence: 10 },
    ];
